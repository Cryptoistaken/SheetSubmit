...
components/layout/Sidebar.tsx         # desktop-only (lg:+) collapsible nav (240px ↔ 64px icons, ss_sidebar_collapsed): home-section links + Admin group, balance toggle, theme toggle, avatar + logout; sheet pages never mount it

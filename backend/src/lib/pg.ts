...
function classify(r: Row, p?: string | null): Pool | null {
  ...
  // strict routing: a file type feeds ONLY its own pool — 2fa files → cookies_2fa, page files → page; key-less rows are invalid (counted in pool_rejects), never cookies_only

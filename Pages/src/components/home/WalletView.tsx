...
const METHODS = [{ id: "bKash", label: "bKash", icon: "/bKash.svg", text: false }, { id: "Nagad", label: "Nagad", icon: "/nagad.svg", text: false }, { id: "USDT", label: "USDT", icon: "/usdt.svg", text: true }] as const;

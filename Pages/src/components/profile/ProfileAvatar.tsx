...
export default function ProfileAvatar({
  ...
  return (
    <span style={{ position: "relative", display: "inline-flex", flexShrink: 0 }}>
      ...
      {verified ? (
        <span title="Verified" style={{ position: "absolute", right: -4, bottom: -4, width: badgeSize, height: badgeSize, display: "grid", placeItems: "center", color: "#1d9bf0", filter: "drop-shadow(0 1px 2px rgba(0,0,0,.15))" }}>
